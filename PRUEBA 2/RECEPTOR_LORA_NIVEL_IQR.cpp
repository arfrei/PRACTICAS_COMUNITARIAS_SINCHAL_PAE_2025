...
const char* mqttClientID = "PAYRIzQhNQIlNQAQIg4PHBA";
const char* mqttUsername = "PAYRIzQhNQIlNQAQIg4PHBA";
const char* mqttPassword = "juXzma+Dmy1RMepUrcXNM+iZ";
const char* mqttTopic = "channels/2909722/publish/fields/field1"; 
WiFiClient espClient;
PubSubClient client(espClient);
bool estadoMQTT = false;

// Configuración de HTTP
String serverUrl = "http://192.168.1.130:5000/guardar_altura"; //Reemplazar localhost por la ip fija del servidor Flask
bool estadoHTTP = false;

// Variables para control de timeout y reconexión
unsigned long ultimoPaqueteMillis = 0;
unsigned long intervaloTimeout = 85000; //1min 25 seg
bool falloLoraReportado = false;
unsigned long ultimoIntentoWiFi = 0;
const unsigned long intervaloWiFi = 10000; //10 seg
